...
function updateFromRTC(payload) {
  ...
  if (gameStarted && distToSun(mySelf)>20e3 && !userNotifyedAwayFromSun) {
    ...
    //delayedTip(3, `...but you can't recharge.`)
    notify(`You are far away from Sun! Good, you can't be found on radar.`)
    setTimeout(()=> notify(`...but you can't recharge.`), 3000)
...
/* radius: planet size/2
   ...
   noize: texture
*/
  { radius: 200, a:0,  d:2e3, r:80,  g:80,  b:80 },

  { radius: 300, a:0,  d:4e3, r:100, g:50,  b:30  },
  { radius: 400, a:PI, d:4e3, r:150, g:80,  b:130 },

  { radius: 350, a:0     , d:8e3, r:0,   g:80,  b:200 },
  { radius: 450, a:PI*.66, d:8e3, r:30,  g:100, b:0   },
  { radius: 350, a:PI*1.3, d:8e3, r:180, g:60,  b:60  },

  { radius: 800, a:0    , d:12e3, r:0,   g:40,  b:220 },
  { radius: 700, a:PI*.9, d:12e3, r:160, g:140, b:40  },

  { radius: 300, a:0    , d:16e3, r:120,  g:120,  b:120 },
  { radius: 200, a:PI/2 , d:16e3, r:100,  g:80,   b:50  },
  { radius: 300, a:PI   , d:16e3, r:120,  g:120,  b:100 },
  { radius: 200, a:PI*1.6,d:16e3, r:120,  g:50,   b:100 },
